...
`.data/scripts/` directory is installed onto the path, which is what makes `godharness` a command.
"""
...
NAME = "godharness"
SUMMARY = "Agent-context and documentation-governance framework."
...
def wheel_metadata(tag: str) -> str:
    return (
        "Wheel-Version: 1.0\n"
        "Generator: godharness packaging/build_wheels.py\n"
